...
open class WholeRouteMapFragment : Fragment() ,
	...
	private var _binding : FragmentWholeRouteMapBinding? =
			null
	private val binding get() = _binding !!
	private var _bindingDialog : DialogLayoutBinding? =
			null
...
//    private var sonido: Int = -1
	...
	override fun onCreateView(
		...
		_binding =
				FragmentWholeRouteMapBinding.inflate(layoutInflater)
		
		model =
				ViewModelProvider(this).get(WholeRouteViewModel::class.java)
		
		adapter =
				DeliveryListingAdapter(
						mutableListOf() ,
						requireContext() ,
						this , //this
				                      )
...
//          setSoundEfect()
	...
	private fun initRecyclerView() {
		...
		binding.recyclerMainPage.adapter =
				adapter
	}
	...
	override fun viewTouchedShort(deliveryPointEntity : DeliveryPointEntity ,
	                              position : Int) {
		Toast
				.makeText(
						requireContext() ,
	...
	override fun viewTouchedLong(deliveryPointEntity : DeliveryPointEntity ,
	                             id : Int) {
		generatePhoneCall()
	}
...
//        val bind : Ph
		val dialogView =
				layoutInflater
						.inflate(R.layout.phonecall_dialog ,
						         null)
		val dialogBuilder =
				AlertDialog
