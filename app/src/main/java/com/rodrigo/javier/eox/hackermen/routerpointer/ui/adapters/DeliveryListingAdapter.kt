...
class DeliveryListingAdapter(private var list : MutableList<DeliveryPointEntity> = mutableListOf() ,
	...
	override fun onCreateViewHolder(parent : ViewGroup , viewType : Int) : BaseViewHolder<*> {
		var binding = ItemPointBinding.inflate(LayoutInflater.from(context) , parent , false)
		...
		binding.imageViewPhonecall.setOnLongClickListener {
			...
			YoYo.with(Techniques.RubberBand).duration(450).repeat(5).playOn(binding.carviewItem)
